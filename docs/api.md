...
- A request body larger than the path cap answers `413 {"detail": "request body too large"}` before the route runs. JSON and form requests cap at 1 MiB, file uploads at 64 MiB, and SES feedback at 512 KiB.
