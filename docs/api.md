...
| DELETE `/api/v1/account/totp` | implemented | remove the second factor; needs recent authentication and a current code or a recovery code, spends the same attempt budget as replacing one, and ends the account's other sessions |
