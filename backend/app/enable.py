...
def main() -> None:
    ...
    print()
    print("Open this link within one hour to claim the administrator account:")
    print(f"  {base}/setup#{token}")
    print()
    print("The link is one use. Running this again replaces it.")
    print("It is not stored anywhere; only its hash is.")
    print()
    print("Restart the API with AUTH_MODE=accounts to serve it. Until sign-in")
    print("ships, accounts mode authenticates nobody except through this link.")
