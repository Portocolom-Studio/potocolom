	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				...
				surface:
					'h-auto border-white/[0.09] bg-white/[0.03] px-[0.9rem] py-[0.3rem] text-[0.78rem] font-normal text-[#8b95ab]',
